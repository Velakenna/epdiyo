    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} has just started bot to check <code>HELP COMMANDS</code>\n\n**USER ID:** {sender_id}\n**USER NAME:** {sender_name}",
                )
        ...
        if name[0:3] == "sud":
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} has just started bot to check <code>SUDOLISTS</code>\n\n**USER ID:** {sender_id}\n**USER NAME:** {sender_name}",
                )
            return
        if name[0:3] == "lyr":
